...
describe("Form", () => {
  ...
  it("validates that the interviewer cannot be null", () => {
    const onSave = jest.fn();
    const { getByText } = render(<Form name="Sylvia Palmer" onSave={onSave} interviewers={interviewers} interviewer={null} />);
    fireEvent.click(getByText("Save"));
  ...
  //   const onSave = jest.fn();
  //   const { getByText, queryByText } = render(<Form name="Lydia Miller-Jones" onSave={onSave} interviewers={interviewers} interviewer={interviewers[0].id} />);
  //   fireEvent.click(getByText("Save"));
